...
_cmux_report_pr_for_path() {
    ...
    local branch commit_sha="" ref_key="" repo_slug="" gh_output="" gh_error="" err_file="" gh_status number state url status_opt=""
    ...
    if (( gh_status != 0 )) || [[ -z "$gh_output" ]]; then
        ...
        # Always scope PR detection to the exact current branch or detached commit. Preserve the
