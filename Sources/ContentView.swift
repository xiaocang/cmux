...
struct VerticalTabsSidebar: View {
    ...
    private func workspaceRow(
        ...
        let resolvedShowsModifierShortcutHints = SidebarShortcutHintFreezePolicy().resolved(
            live: resolvedPresentation.showsModifierShortcutHints,
            currentTabId: tab.id,
...
struct WorkspaceSidebarScoreBadge: Identifiable, Equatable {
...
struct TabItemView: View, Equatable {
    ...
    private func branchDirectorySection(
        ...
        if detailVisibility.showsBranchDirectory {
            if sidebarBranchVerticalLayout {
                ...
                compactStackedBranchDirectorySection(workspaceSnapshot: workspaceSnapshot)
            } else if !workspaceSnapshot.compactBranchDirectoryCandidates.isEmpty {
                compactBranchDirectoryRow(workspaceSnapshot: workspaceSnapshot)
            }
        }
    }
    ...
    @ViewBuilder
    private func compactStackedBranchDirectorySection(
        workspaceSnapshot: SidebarWorkspaceSnapshotBuilder.Snapshot
    ) -> some View {
        HStack(alignment: .top, spacing: 3) {
    ...
    private func decoratedRow(
        ...
        .overlay(alignment: .topTrailing) {
            if showsWorkspaceShortcutHint {
                ...
                .frame(width: scaledFontSize(16), height: scaledFontSize(18), alignment: .center)
                .padding(.top, 8)
                .padding(.trailing, 10)
            }
        }
