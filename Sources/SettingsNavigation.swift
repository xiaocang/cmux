...
enum SettingsNavigationTarget: String, CaseIterable, Identifiable {
    ...
    var searchText: String {
        ...
        case .terminal:
            return "\(title) scrollbar auto resume restore reopen relaunch quit sessions agents claude codex opencode rovodev hibernation idle suspend commands approvals prefixes toggle shell backend livesh direct daemon pty live"
        case .textBox:
        ...
        case .automation:
            return "\(title) socket integrations hooks ports claude cursor gemini kiro sprite local llm ollama semantic router naming auto naming workspace tabs"
        case .browser:
...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "proactive-sprite-suggestions", String(localized: "settings.app.proactiveSpriteSuggestions", defaultValue: "Proactive Sprite Suggestions"), "sprite proactive suggestion next assistant context"),
        ...
        setting(.browser, "site-search", String(localized: "settings.browser.siteSearch", defaultValue: "Site Search"), "omnibar address bar shortcut search engine url template chrome"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.proactiveSpriteSuggestions": settingID(for: .app, idSuffix: "proactive-sprite-suggestions"),
    ...
    static func entries(matching query: String) -> [SettingsSearchEntry] {
        ...
        return (baseEntries + pluginSettingEntries()).enumerated()
