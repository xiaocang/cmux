enum SettingsSearchAliasIndex {
    static func sectionAliases(for target: SettingsNavigationTarget) -> String {
        ...
        case .enhancements:
            return localized("settings.search.alias.section.enhancements", defaultValue: "enhancements github pull request refresh debounce coalesce merge")
        case .automation:
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:proactive-sprite-suggestions": localized("settings.search.alias.setting.app.proactive-sprite-suggestions", defaultValue: "app.proactiveSpriteSuggestions sprite proactive suggestion suggestions next step assistant context what to do waiting ci review merge"),
        ...
        "enhancements:github-pr-refresh": localized("settings.search.alias.setting.enhancements.github-pr-refresh", defaultValue: "github pull request pr refresh delay debounce coalesce shell prompt command hint merge"),
        ...
        "browser:site-search": localized("settings.search.alias.setting.browser.site-search", defaultValue: "browser.siteSearch browser.siteSearchKeyboardShortcut omnibar address bar site search shortcut template chrome tab space"),
        ...
        "browser:hidden-webview-discard": localized("settings.search.alias.setting.browser.hidden-webview-discard", defaultValue: "browser.discardHiddenWebViews memory hidden tabs webview discard unload reclaim lru retention limit"),
        "browser:hidden-webview-discard-delay": localized("settings.search.alias.setting.browser.hidden-webview-discard-delay", defaultValue: "browser.hiddenWebViewDiscardDelaySeconds memory hidden tabs delay seconds discard unload lru grace"),
