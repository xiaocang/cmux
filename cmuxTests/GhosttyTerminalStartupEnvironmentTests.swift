...
struct GhosttyTerminalStartupEnvironmentTests {
    ...
    func testApplyManagedClaudePermissionRequestHookEnvironmentEnablesInteractiveApprovalHook() {
        ...
        #expect(merged[TerminalSurface.claudePermissionRequestHookEnvironmentKey] == "1")
        #expect(protectedKeys.contains(TerminalSurface.claudePermissionRequestHookEnvironmentKey))
    }
