...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "proactive-sprite-suggestions", title: "Proactive Sprite Suggestions", synonyms: "app.proactiveSpriteSuggestions sprite proactive suggestion suggestions next step assistant context what to do waiting ci review merge reminder remind"),
            .init(section: .app, id: "proactive-auto-bubble", title: "Proactive Sprite Auto-Bubble", synonyms: "app.proactiveAutoBubble sprite proactive auto bubble popup speech high priority reminder remind"),
            .init(section: .app, id: "proactive-suggestion-notifications", title: "Proactive Suggestion Notifications", synonyms: "app.proactiveSuggestionNotifications sprite proactive desktop notification background high priority reminder remind"),
            ...
            .init(section: .terminal, id: "shell-backend", title: "Shell Backend", synonyms: "terminal.shellBackend live shell livesh direct daemon pty persistent reattach outlive"),
            ...
            .init(section: .automation, id: "sprite-local-llm", title: "Sprite Local LLM Router", synonyms: "sprite semantic router local llm ollama model provider base url timeout openai compatible language model routing"),
            .init(section: .automation, id: "pr-shell-debounce", title: "Debounce Sidebar PR Shell Refreshes", synonyms: "automation.sidebarPullRequestShellDebounceEnabled sidebar pull request pr shell refresh debounce coalesce rate limit"),
            .init(section: .automation, id: "pr-shell-debounce-seconds", title: "PR Shell Debounce Window", synonyms: "automation.sidebarPullRequestShellDebounceSeconds sidebar pull request pr shell refresh debounce window seconds delay"),
            .init(section: .digest, id: "enabled", title: "Enable Workspace Digest", synonyms: "digest.enabled digest workspace summary summarize sidebar radar cmux-digest"),
            .init(section: .digest, id: "provider", title: "Digest Provider", synonyms: "digest.provider digest provider claude code codex cli summary"),
            .init(section: .digest, id: "model", title: "Digest Model", synonyms: "digest.model digest model cli summary custom preset"),
            .init(section: .digest, id: "summary-priority", title: "Enable Summary Priority", synonyms: "workspaceTab.summaryPriority.enabled summary priority rank workspace extension column digest"),
            .init(section: .digest, id: "ghpr-enabled", title: "Enable ghpr Integration", synonyms: "digest.ghpr.enabled ghpr pr pull request prdashboard socket integration digest"),
            .init(section: .digest, id: "ghpr-socket-path", title: "ghpr Socket Path", synonyms: "digest.ghpr.socketPath ghpr socket path unix prdashboard digest"),
            .init(section: .digest, id: "ghpr-display-items", title: "ghpr Display Items", synonyms: "digest.ghpr.displayItems ghpr display items ci review unresolved jira title draft conflicts sidebar digest"),
            .init(section: .digest, id: "ghpr-jira-base-url", title: "Jira Base URL", synonyms: "digest.ghpr.jiraBaseURL ghpr jira base url ticket link digest"),
            ...
            .init(section: .browser, id: "site-search", title: "Site Search Shortcut", synonyms: "browser.siteSearchKeyboardShortcut site search shortcut tab space address bar keyword activation key"),
