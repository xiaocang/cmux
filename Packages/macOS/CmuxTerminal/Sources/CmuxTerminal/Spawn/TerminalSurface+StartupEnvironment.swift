...
extension TerminalSurface {
    ...
    /// Environment key that opts a spawned Claude session into the cmux
    /// permission-request hook.
    public static let claudePermissionRequestHookEnvironmentKey = "CMUX_CLAUDE_PERMISSION_REQUEST_HOOK"
    ...
    /// Applies the Claude permission-request hook opt-in key and protects it.
    public static func applyManagedClaudePermissionRequestHookEnvironment(
        to environment: inout [String: String],
        protectedKeys: inout Set<String>
    ) {
